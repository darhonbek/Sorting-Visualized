...
protocol MergeSortVisualizerProtocol {
    func mergeSort<T: Comparable>(_ array: [T]) -> [T]
}

protocol MergeSortVisualizerDelegate: AnyObject {
    func mergeSortVisualizer(_ visualizer: MergeSortVisualizer, didCompare firstIndex: [Int], with secondIndex: [Int])
    func mergeSortVisualizer(_ visualizer: MergeSortVisualizer, didSwap firstIndex: [Int], with secondIndex: [Int])
}

class MergeSortVisualizer: MergeSortVisualizerProtocol {
    weak var delegate: MergeSortVisualizerDelegate?
